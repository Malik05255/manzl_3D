...
from .openings import detect_doors,detect_windows,fuse_ai_opening_detections,fuse_pdf_vector_windows,normalize_opening_hosts
...
def analyze_document_bytes_local(
    ...
    *,
    ...
    if vector_lines:
        windows=fuse_pdf_vector_windows(
            topology_walls,windows,vector_lines,w,h,
        )
    if ai_detections:
