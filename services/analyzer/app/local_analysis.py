...
def analyze_document_bytes_local(
    ...
    *,
    ...
    phase_timings["decodePreprocess"]=round(time.perf_counter()-phase_started,4)
    ...
    phase_timings["pdfNativeEvidence"]=round(time.perf_counter()-phase_started,4)
    ...
    phase_timings["ocr"]=round(time.perf_counter()-phase_started,4)
    ...
    phase_timings["symbolDetector"]=round(time.perf_counter()-phase_started,4)
    ...
    phase_timings["walls"]=round(time.perf_counter()-phase_started,4)
    ...
    phase_timings["roomsTopology"]=round(time.perf_counter()-phase_started,4)
    ...
    analysis={
        ...
        "phaseTimingsSeconds":phase_timings,
    }
    if ai_detections:
        detector_counts={}
